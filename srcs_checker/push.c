...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/10 10:48:57 by focampo           #+#    #+#             */
/*   Updated: 2021/05/10 10:48:58 by focampo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push_a_to_b(t_list **from_a, t_list **to_b)
{
	...
	if (*from_a == NULL || from_a == NULL)
		return ;
	tmp_a = *from_a;
	tmp_b = *to_b;
	ft_lstadd_front(to_b, ft_lstnew(tmp_a->content));
...
void	push_b_to_a(t_list **from_b, t_list **to_a)
{
	...
	tmp_b = *from_b;
	tmp_a = *to_a;
	ft_lstadd_front(to_a, ft_lstnew(tmp_b->content));
